...
export const comparisonData = {
  rivolia: {
    ...
    features: [
      { icon: "check", text: "No es polvo soluble, es cafe para pasar" },
      { icon: "check", text: "Sabor limpio y natural" },
      { icon: "check", text: "Sin ese gusto artificial tipico del instantaneo" },
      { icon: "check", text: "Aroma fresco" },
      { icon: "check", text: "Se siente como cafe recien hecho" },
      { icon: "check", text: "Listo en 3 minutos" },
      { icon: "check", text: "Rapidez sin sacrificar calidad" },
    ],
  },
  instantaneo: {
    title: "Cafe Instantaneo",
    features: [
      { icon: "x", text: "Polvo ultraprocesado" },
      { icon: "x", text: "Pierde gran parte del perfil original" },
      { icon: "x", text: "Sabor plano artificial" },
      { icon: "x", text: "No hay complejidad ni textura" },
      { icon: "x", text: "Aroma debil a quimico" },
      { icon: "x", text: "No genera expectativas" },
      { icon: "x", text: "Menor percepcion de calidad" },
      { icon: "x", text: "Rapido y basico" },
    ],
  },
} as const;
